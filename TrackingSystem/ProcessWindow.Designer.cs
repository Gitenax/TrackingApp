namespace TrackingSystem
{
	partial class ProcessWindow
	{
		...
		private void InitializeComponent()
		{
			...
			// pictureBox1
			// 
			this.pictureBox1.BackgroundImage = global::TrackingSystem.Properties.Resources.ProcessClock;
			...
			this.label1.Text = "Идет создание отчета...";
			// 
			// progressBar1
			// 
			this.progressBar1.Location = new System.Drawing.Point(97, 51);
			...
			this.Text = "Обработка... Пожалуйста подождите";
